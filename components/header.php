...
?>
    ...
    <header>
        <!-- <a id="anker"><img id="imgStart" class="img_spiegeln" src="images/yogaStartscreen.jpg" /></a> -->
        <div class="nav_pos flex">
            ...
            <?php foreach ($menuItems as $name => $link): ?>
                <div class="navbar">
                    <a class="linkNav color-white" href="<?= $link ?>"><?= $name ?></a>
                </div>
            <?php endforeach; ?>
        ...
        <div class="responsive_navbar">
            ...
            <div class="responive_nav bg-color_dark">
                ...
                <div id="social_links">
                    <?php foreach ($menuItems as $name => $link): ?>
                        <a class="linkNav2" href="<?= $link ?>"><?= $name ?></a>
