...
window.onload = function () {
  ...
  var button_responsive = document.getElementsByClassName(
    "bkursStart_responsive"
  );
  ...
  var button_fortgeschritten = document.getElementsByClassName(
    "button-fortgeschritten"
  );
...
function anmeldung() {
  ...
  var bezahlmethode_text = document.getElementById(
    "text_anmeldung_bezahlmethode"
  );
  ...
  if (checkAGB == false && checkName == false && checkEmail == false) {
    ...
    document.getElementById("angemeldet").innerText =
      "Du bist erfolgreich angemeldet " + name_angemeldet;
